...
\begin{center}
	\begin{tabular}{|c|c|c|c|c|}
		...
		Biến thiên & SS & DF & MS & Fisher\\
		\hline
		$R_{X_1,X_2}$ & $SSR = 980.63+224.22 = 1204.85$ & 1 &$SSR/2 = 602.425$ & $MSR/MSE $\\
		\hline
		$E$ & $SSE = 215.81$ & $n-2 = 9$ & $SSE/9 = 23.9789$ & $= 25.123 $\\
		\hline
...
{\centering{$H_0 : \beta_1 = \beta_2= 0$}\\}
Đối thuyết \hspace{4.5cm}$H_1: \beta_1 \neq 0 \vee \beta_2 \neq 0 $
\begin{figure}[h!]
	\centering
...
95\% khoảng tin cậy của $\hat{\sigma^2}$ là (3.292832;20.77248)
...
\end{center}
Kết quả mô hình trên khi thêm 2 biến độc lập $x_3$ và $x_2$
\begin{center}
\includegraphics{bai3_10i.PNG} 
\end{center}
Do thực hiện trên cùng mẫu, số lượng biến độc lập khác nhau, ta so sánh giá trị $R^2$ hiệu chỉnh. Nhận thấy:
$$R^2_{adj_1} = 0.4785 < R^2_{adj_3} = 0.6135$$
Ta có thể kết luận, khi thêm  2 biến độc lập $x_3$ và $x_2$ vào mô hình chỉ với 1 biến độc lập $x_1$ thì làm cho chất lượng ước lượng cao hơn.
